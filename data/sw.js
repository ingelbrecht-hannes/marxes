...
var ea = function(a, b, c, d) {
    return h(function*() {
        if (c.length < (a.o ? 28 : 16))
            throw new u("ciphertext too short");
        if (b.length !== 12)
            throw new u("IV must be 12 bytes");
        const e = {
            name: "AES-GCM",
            iv: b,
            tagLength: 128
...
;
function G({key: a, o: b}) {
    return h(function*() {
        if (![16, 32].includes(a.length))
            throw new v("unsupported AES key size: ${n}");
...
function ha(a, b) {
    return h(function*() {
        ...
        if (!c)
            throw new v("namedCurve must be provided");
...
function ja(a) {
    return h(function*() {
        ...
        if (b.crv === void 0)
            throw new v("crv must be provided");
        const c = K(I(b.crv));
        if (b.x === void 0)
            throw new v("x must be provided");
        if (b.y === void 0)
            throw new v("y must be provided");
        const d = C(b.x);
        if (d.length !== c)
            throw new v(`x-coordinate byte-length is invalid (got: ${d.length}, want: ${c}).`);
        const e = C(b.y);
        if (e.length !== c)
            throw new v(`y-coordinate byte-length is invalid (got: ${e.length}, want: ${c}).`);
        return b
    })
}
function ka(a) {
...
function va({K: a, J: b, G: c}) {
    return A(ua, a, b, c)
}
function P({m: a, l: b, j: c}) {
    return A(O, c, D(a), b)
}
function wa({u: a, info: b, j: c, length: d}) {
...
function ya(a) {
    return h(function*() {
        const b = a.algorithm
          , c = yield ja(a);
        if (!c.crv)
            throw new u("Curve has to be defined.");
        var d;
        {
...
;var za = class {
    ...
    seal({key: a, nonce: b, M: c, C: d}) {
        const e = this;
        return h(function*() {
            if (a.length !== e.B)
                throw new u("Unexpected key length: " + a.length.toString());
...
function Q(a) {
    if (a == null || !(a instanceof Uint8Array))
        throw new v("input must be a non null Uint8Array");
}
;var Ba = function(a, b) {
    return h(function*() {
        Q(b);
...
function Da(a, b, c) {
    return h(function*() {
        ...
        if (!Number.isInteger(c))
            throw new v("invalid tag size, must be an integer");
        if (c < 10)
            throw new v("tag too short, must be at least " + (10).toString() + " bytes");
        switch (a) {
        case "SHA-1":
            if (c > 20)
                throw new v("tag too long, must not be larger than 20 bytes");
            break;
        case "SHA-256":
            if (c > 32)
                throw new v("tag too long, must not be larger than 32 bytes");
            break;
        case "SHA-384":
            if (c > 48)
                throw new v("tag too long, must not be larger than 48 bytes");
            break;
        case "SHA-512":
            if (c > 64)
                throw new v("tag too long, must not be larger than 64 bytes");
            break;
        default:
...
;var Ea = function(a, b, c) {
  ...
  , V = function(a, {l: b, m: c, j: d, salt: e}) {
    return h(function*() {
        return yield Ea(a, P({
            m: c,
            l: b,
  ...
  , Fa = function(a, b, c, d) {
    return h(function*() {
        if (!Number.isInteger(d))
            throw new u("length must be an integer");
        if (d <= 0)
            throw new u("length must be positive");
        const e = U(a);
        if (d > 255 * e)
            throw new u("length too large");
        Q(c);
  ...
  , Ga = function(a, {F: b, info: c, u: d, j: e, length: f}) {
    return h(function*() {
  ...
  , Ha = function(a, {l: b, m: c, info: d, u: e, j: f, length: g, salt: k}) {
    return h(function*() {
...
var Ia = function(a) {
    ...
    if (d.length !== c.length)
        throw new v("Both byte arrays should be of the same length");
    const e = new Uint8Array(d.length);
    for (let f = 0; f < e.length; f++)
        e[f] = d[f] ^ c[f];
    if (a.g >= a.i)
        throw new u("message limit reached");
    a.g += BigInt(1);
    return e
}
  , Ja = class {
...
function Ra(a, b) {
    if (b !== a.type)
        throw new v(`keyPair ${b} key was of type ${a.type}`);
    const c = a.algorithm;
    if ("ECDH" !== c.name)
        throw new v(`keyPair ${b} key should be ECDH but found ${c.name}`);
}
;var Ta = function(a) {
    switch (a) {
    case 1:
...
function Va(a, b) {
    ...
    return k => h(function*() {
        if (!g)
            throw new u("Context has already been used");
        const n = g;
        g = null;
        const q = yield n
          , r = yield q.seal(k, new Uint8Array(0));
        return A(q.D, r)
    })
}
;var Wa = function(a, b) {
...
var fb = function(a, b) {
  ...
  , gb = function(a, b) {
    b && (Y(b.send_pixel, b.options, a.i),
    Y(b.create_iframe, b.options, a.A),
    Y(b.fetch, b.options, a.h))
}
  , hb = function(a, b) {
    b = a.g + b;
    let c = b.indexOf("\n\n");
    for (; c !== -1; ) {
        ...
        a: {
            ...
            if (f.indexOf("event: message") === 0 && g.indexOf("data: ") === 0)
                try {
  ...
  , ib = function(a, b) {
    return () => {
        b.fallback_url && b.fallback_url_method && gb(a, {
...
var mb = function(a, b, c) {
  ...
  , nb = function(a, b, c) {
    return h(function*() {
        ...
        let {url: f, body: g} = b;
        const {attributionReporting: k, templates: n, processResponse: q, method: r=0, referer: E} = b
          , B = RegExp("\\${([^${}]*?)}", "g")
          , J = m => {
            if (m == null)
                return w => h(function*() {
