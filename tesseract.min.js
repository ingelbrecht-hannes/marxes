...
!function(t, e) {
    ...
    var t = {
        ...
        760: (t, e, r) => {
            ...
            var o = function(t) {
                "use strict";
                var e, r = Object.prototype, o = r.hasOwnProperty, i = Object.defineProperty || function(t, e, r) {
                    t[e] = r.value
                }
        ...
        311: (t, e, r) => {
            ...
            t.exports = f(i().mark((function t() {
                var e, r, n, a, u, l, m, S, k, P, _, N, T, A, G, I, F, R, D, M, U, C, z, Y, B, H, K, W, J, V, Z = arguments;
                return i().wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                            return e = Z.length > 0 && void 0 !== Z[0] ? Z[0] : {},
                            r = v("Worker", E),
                            n = p(c(c({}, b), e)),
                            a = n.logger,
                            u = n.errorHandler,
                            ...
                            I = function(t) {
                                ...
                                return new Promise((function(t, i) {
                                    d("[".concat(r, "]: Start ").concat(e, ", action=").concat(n)),
                                    A(n, t),
                                    G(n, i),
                                    j(T, {
                                        workerId: r,
                            ...
                            z = function() {
                                return I(y({
                                    ...
                                    action: "loadLanguage",
                                    payload: {
                                        langs: arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "eng",
                                        options: l
                                    }
                                }))
                            }
                            ...
                            Y = function() {
                                return I(y({
                                    id: arguments.length > 3 ? arguments[3] : void 0,
                                    action: "initialize",
                                    payload: {
                                        langs: arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "eng",
                                        oem: arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : g,
                                        config: arguments.length > 2 ? arguments[2] : void 0
                                    }
                                }))
                            }
                            ,
                            ...
                            O(T, (function(t) {
                                ...
                                if ("resolve" === n) {
                                    ...
                                    var s = i;
                                    "recognize" === o ? s = h(i) : "getPDF" === o && (s = Array.from(c(c({}, i), {}, {
        ...
        129: (t, e, r) => {
            ...
            t.exports = function(t) {
                var e = {};
                return "undefined" != typeof WorkerGlobalScope ? e.type = "webworker" : o() ? e.type = "electron" : "object" === ("undefined" == typeof window ? "undefined" : n(window)) ? e.type = "browser" : "object" === ("undefined" == typeof process ? "undefined" : n(process)) && (e.type = "node"),
                void 0 === t ? e : e[t]
            }
        }
        ,
        ...
        187: (t, e, r) => {
            ...
            var a = "browser" === r(129)("type") ? function(t) {
        ...
        854: (t, e, r) => {
            ...
            var c, u = r(147).version, s = r(341);
            t.exports = i(i({}, s), {}, {
                workerPath: "undefined" != typeof process && "development" === process.env.TESS_ENV ? (c = "/dist/worker.dev.js?nocache=".concat(Math.random().toString(36).slice(3)),
                new URL(c,window.location.href).href) : "https://cdn.jsdelivr.net/npm/tesseract.js@v".concat(u, "/dist/worker.min.js"),
                corePath: null
            })
        }
        ,
                ...
                function O(t, r) {
                    function n(i, a, c, u) {
                        ...
                        if ("throw" !== s.type) {
                            var l = s.arg
                              , f = l.value;
                            return f && "object" == e(f) && o.call(f, "__await") ? r.resolve(f.__await).then((function(t) {
                                n("next", t, c, u)
                            }
                            ), (function(t) {
                                n("throw", t, c, u)
